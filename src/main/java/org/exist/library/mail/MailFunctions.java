...
import static org.exist.library.mail.MailModule.functionSignature;

/**
 * Some very simple XQuery example functions implemented
 * in Java.
 */
public class MailFunctions extends BasicFunction {
    ...
    public MailFunctions(final XQueryContext context, final FunctionSignature signature) {
